...
\author:    Module originally by Tansel Halic, moved by Sean Radigan


\version    1.0
\date       09/2014
\bug	    None yet
\brief	    This Module has data structures and some utility functions.
...
extern inline int tri_tri_intersect_with_isectline_penetrationDepth(float V0[3],float V1[3],float V2[3],
...
extern inline int triBoxOverlap(float boxcenter[3],float boxhalfsize[3],float triverts[3][3]);
...
void smAABB::subDivide(smInt p_divisionX,smInt p_divisionY, smInt p_divisionZ ,smAABB *p_aabb){
	smFloat stepX;
	smFloat stepY;
	smFloat stepZ;
...
smBool smCollisionUtils::checkAABBTriangle(smAABB &p_aabb,smVec3f v1,smVec3f v2,smVec3f v3){
	smVec3f  boxhalfsize;
	smVec3f boxCenter;
...
{
	if(tri_tri_intersect_with_isectline_penetrationDepth((smFloat*)&p_tri1Point1,(smFloat*)&p_tri1Point2,(smFloat*)&p_tri1Point3,
		(smFloat*)&p_tri2Point1,(smFloat*)&p_tri2Point2,(smFloat*)&p_tri2Point3,
		&coplanar,
...
smBool smCollisionUtils::tri2tri(smVec3<smFloat> &p_tri1Point1,
	                             ...
	                             smVec3<smFloat> &p_tri2Point2,
	                             smVec3<smFloat> &p_tri2Point3){
	return (tri_tri_intersect((smFloat*)&p_tri1Point1,(smFloat*)&p_tri1Point2,(smFloat*)&p_tri1Point3,(smFloat*)&p_tri2Point1,(smFloat*)&p_tri2Point2,(smFloat*)&p_tri2Point3)==1?true:false);
}
...
///If the point is in the triangle, it will also send the barycentric coord.
