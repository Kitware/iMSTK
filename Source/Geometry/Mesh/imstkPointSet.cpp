...
PointSet::setVertexNormals(const std::string& arrayName)
{
    if (hasVertexAttribute(arrayName))
    {
        setActiveAttribute(m_activeVertexNormals, arrayName, 3, IMSTK_DOUBLE);
    }
}
...
PointSet::setVertexTangents(const std::string& arrayName)
{
    if (hasVertexAttribute(arrayName))
    {
        setActiveAttribute(m_activeVertexTangents, arrayName, 3, IMSTK_FLOAT);
    }
}
...
PointSet::setVertexTCoords(const std::string& arrayName)
{
    if (hasVertexAttribute(arrayName))
    {
        setActiveAttribute(m_activeVertexTCoords, arrayName, 2, IMSTK_FLOAT);
    }
}
...
void
PointSet::setActiveAttribute(std::string& activeAttributeName, std::string attributeName,
