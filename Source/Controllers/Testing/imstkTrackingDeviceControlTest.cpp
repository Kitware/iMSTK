...
TEST_F(TrackingDeviceControlTest, EndEffector)
{
        ...
        EXPECT_TRUE(expected.isApprox(control.getOrientation())) << "Expected: " << expected.coeffs().transpose() << " Actual: " << control.getOrientation().coeffs().transpose();
}
...
TEST_F(TrackingDeviceControlTest, TranslationOffset)
{
        ...
        EXPECT_TRUE(expectedRot.isApprox(control.getOrientation()))
                << "Expected: " << expectedRot.coeffs().transpose() << " Actual: " << control.getOrientation().coeffs().transpose();
}
