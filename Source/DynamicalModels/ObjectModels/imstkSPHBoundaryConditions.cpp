...
namespace imstk
{
SPHBoundaryConditions::SPHBoundaryConditions(const std::pair<Vec3d, Vec3d>& inletDomain, const std::pair<Vec3d, Vec3d>& outletDomain,
  const Vec3r& inletVelocity, StdVectorOfVec3d& mainParticlePositions, const StdVectorOfVec3d& wallParticlePositions):
  m_inletDomain(inletDomain), m_outletDomain(outletDomain), m_inletVelocity(inletVelocity)
{
