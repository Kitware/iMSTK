...
// Union based variant, does not provide discriminator
class Variant
{
public:
    Variant(char val) { Data.char_value = val; }
    Variant(unsigned char val) { Data.uchar_value = val; }
    Variant(short val) { Data.short_value = val; }
    Variant(unsigned short val) { Data.ushort_value = val; }
    Variant(int val) { Data.int_value = val; }
    Variant(unsigned int val) { Data.uint_value = val; }
    Variant(long val) { Data.long_value = val; }
    Variant(unsigned long val) { Data.ulong_value = val; }
    Variant(float val) { Data.float_value = val; }
    Variant(double val) { Data.double_value = val; }
    Variant(long long val) { Data.longlong_value = val; }
    Variant(unsigned long long val) { Data.ulonglong_value = val; }
...
public:
    ...
    inline ScalarType getType() const { return type; }

private:
    template<typename T>
    static T ToNumeric(const Variant& v);

private:
    ScalarType type = IMSTK_CHAR;
