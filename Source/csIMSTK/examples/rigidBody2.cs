...
public class RigidBody2
{
    ...
    private static void runRigidBody2()
    {
        ...
        RigidObject2 cubeObj = new RigidObject2("Cube");
        {
            ...
            {
                Cube cubeGeom = new Cube();
                cubeGeom.setWidth(4.0);
                SurfaceMesh surfMesh = modIMSTK.toCubeSurfaceMesh(cubeGeom);
            ...
            RigidObjectCollidingCollisionPair rbdInteraction = new RigidObjectCollidingCollisionPair(cubeObj, planeObj, CollisionDetection.Type.PointSetToImplicit);
            RigidBodyCH ch = modIMSTK.castToRigidBodyCH(rbdInteraction.getCollisionHandlingA());
