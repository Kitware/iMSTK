public class PbdCollisionOneObject
{
    ...
    private static void runPbdCollisionOneObject()
    {
        ...
        Scene scene = new Scene("PbdCollisionOneDragon");
        {
            ...
            SurfaceMesh coarseSurfMesh = new SurfaceMesh();
            ...
            // Collision
            scene.getCollisionGraph().addInteraction(modIMSTK.makeObjectInteractionPair(deformableObj, floorObj,
    ...
    private const string surfMeshFileName = "../../../install/data/asianDragon/asianDragon.obj";
    private const string tetMeshFileName  = "../../../install/data/asianDragon/asianDragon.veg";
