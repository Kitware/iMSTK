...
void main(){
	...
	MetalShaderShadow *metalShader=new MetalShaderShadow("../../resources/shaders/MultipleShadowsVertexBumpMap2.cg","../../resources/shaders/MultipleShadowsFragmentBumpMap2.cg");
	...
	viewer->viewerRenderDetail=viewer->viewerRenderDetail|SOFMIS_VIEWERRENDER_GLOBALAXIS|SOFMIS_VIEWERRENDER_SOFTSHADOWS|SOFMIS_VIEWERRENDER_RESTORELASTCAMSETTINGS;
