...
bool PositionBasedModel::initConstraints(PbdConstraint::Type type)
{
    switch (type) {
    ...
    case PbdConstraint::Type::FEMTet : {
        ...
        for (int k = 0; k < elements.size(); ++k) {
            ...
            FEMTetConstraint* c = new FEMTetConstraint(FEMConstraint::MaterialType::NeoHookean);
    ...
    case PbdConstraint::Type::Area : {
        ...
        for (int k = 0; k < elements.size(); ++k) {
            ...
            c->initConstraint(*this, tri[0], tri[1], tri[2]);
            m_constraints.push_back(c);
        }
        break;
    }
        ...
        for (int k = 0; k < elements.size(); ++k) {
            ...
            if (E[tri[0]][tri[1]] && E[tri[1]][tri[0]]) {
                ...
                if (rs.size() > 1) {
                    ...
                    c->initConstraint(*this, tri[2], t[idx], tri[0], tri[1]);
                    m_constraints.push_back(c);
                }
                E[tri[0]][tri[1]] = 0;
            }
            if (E[tri[1]][tri[2]] && E[tri[2]][tri[1]]) {
                ...
                if (rs.size() > 1) {
                    ...
                    DihedralConstraint* c = new DihedralConstraint;
                    c->initConstraint(*this, tri[0], t[idx], tri[1], tri[2]);
                    m_constraints.push_back(c);
                }
                E[tri[1]][tri[2]] = 0;
            }
            if (E[tri[2]][tri[0]] && E[tri[0]][tri[2]]) {
                ...
                if (rs.size() > 1) {
                    ...
                    DihedralConstraint* c = new DihedralConstraint;
                    c->initConstraint(*this, tri[1], t[idx], tri[2], tri[0]);
                    m_constraints.push_back(c);
                }
                E[tri[2]][tri[0]] = 0;
            }
    ...
    default: {
        LOG(WARNING) << " Constraint is not supported !";
        return false;
    }
    }
