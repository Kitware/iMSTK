...
****************************************************
    ...
    \date       04/2009
    \bug	    None yet
    \brief	    This Module automates the loading and using the textures 
...
public:
	...
	static smTextureReturnType loadTexture(const smChar *p_fileName,const smChar *p_textureReferenceName,smInt &p_textureId);
	static smTextureReturnType loadTexture(const smChar *p_fileName,const smChar *p_textureReferenceName, smBool p_flipImage=false,bool deleteDataAfterLoaded=true);
	static smTextureReturnType loadTexture(const smString p_fileName,const smChar *p_textureReferenceName,smBool p_flipImage=false);
	static smTextureReturnType findTextureId(const smChar *p_textureReferenceName, smInt &p_textureId);
	...
	static GLuint activateTexture(const smChar *p_textureReferenceName,smInt p_textureGLOrder);
	static GLuint activateTexture(smTexture *p_texture,smInt p_textureGLOrder,smInt p_shaderBindGLId);
	static GLuint activateTexture(const smChar *p_textureReferenceName,smInt p_textureGLOrder,smInt p_shaderBindName);
	...
	static GLuint disableTexture(const smChar *p_textureReferenceName,smInt p_textureGLOrder);
	...
	static void createDepthTexture(const smChar *p_textureReferenceName,smInt p_width,smInt p_height);
	static void  createColorTexture(const smChar *p_textureReferenceName,smInt p_width,smInt p_height);
	...
	static void duplicateTexture(const smChar *p_textureReferenceName,smTexture *p_texture,ImageColorType p_type);
	static void copyTexture(const smChar *p_textureDestinationName,const smChar *p_textureSourceName);
	static void saveBinaryImage(smChar *p_binaryData,smInt p_width, smInt p_height,const smChar *p_fileName);
	static void saveRGBImage(smChar *p_binaryData,smInt p_width, smInt p_height,smChar *p_fileName);
