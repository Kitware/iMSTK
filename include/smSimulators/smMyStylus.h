...
public:
	...
	MyStylus(smChar *p_shaft="../../resources/models/blunt_diss_pivot.3DS", smChar *p_lower="../../resources/models/blunt_diss_lower.3DS", smChar *p_upper="../../resources/models/blunt_diss_upper.3DS");
