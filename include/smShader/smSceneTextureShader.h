...
class smSceneTextureShader: public smShader, public smEventHandler
{
public:
    ...
    smSceneTextureShader(smChar *p_verteShaderFileName = "shaders/renderSceneVertexShader.glsl",
