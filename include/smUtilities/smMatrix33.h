...
public:
    ...
    {
        e[0][0] = e[0][0] * p_scalar;
        e[0][1] = e[0][1] * p_scalar;
        e[0][2] = e[0][2] * p_scalar;
        e[1][0] = e[1][0] * p_scalar;
        e[1][1] = e[1][1] * p_scalar;
        e[1][2] = e[1][2] * p_scalar;
        e[2][0] = e[2][0] * p_scalar;
        e[2][1] = e[2][1] * p_scalar;
        e[2][2] = e[2][2] * p_scalar;
    }
