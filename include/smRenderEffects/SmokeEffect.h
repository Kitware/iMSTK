...
class SmokeVideo{
	...
	//int			frame[SMOKE_TEXTURES];											// Frame Counter
...
public:
	...
	void drawSmokeVideo( bool grapFrame, bool render,float fadeEffect,float toolTipX,float toolTipY,float depth,float,float,float,smDrawParam p_params);
	smSpark *spark;
private:
