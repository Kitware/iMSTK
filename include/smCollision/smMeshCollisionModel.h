...
{
public:
    using AABBNode = smOctreeCell;
    using AABBTreeType = smSurfaceTree<AABBNode>;
    using TreeNodePairType = std::pair<AABBNode,AABBNode>;
...
public:
    ...
    ///
    /// @brief Loads a tetrahedral mesh and stores it.
    ///
    void loadTetraMesh(const std::string &meshName);
