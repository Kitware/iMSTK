...
PbdTissueGraspingExample()
{
    ...
    auto objShaft = std::make_shared<SceneObject>("objShaft");
    ...
    auto objUpperJaw = std::make_shared<SceneObject>("objUpperJaw");
    ...
    auto objLowerJaw = std::make_shared<SceneObject>("objLowerJaw");
