...
#define NORMAL(NORMALIZED,N,TEMP) \
			TEMP=sqrt(N[0]*N[0]+N[1]*N[1]+N[2]*N[2]); \
			NORMALIZED[0]=N[0]/TEMP; \
			NORMALIZED[1]=N[1]/TEMP; \
			NORMALIZED[2]=N[2]/TEMP; \
                                                      ...
                                                      )
{
 ...
 // NORMAL(NORMALIZED2,N2,temp);
  if   (SIGN01_DIF_SIGN2(dv1,dv2,dv0))
  {
    vSinglePoint=0;  /* V0 is single vertex of the plane of triangle (U0,U1,U2) */
	temp=-(DOT(N2,V0)+d2);
	temp=temp/(N2[0]*N2[0]+N2[1]*N2[1]+N2[2]*N2[2]);
	point1[0]=V0[0]+N2[0]*temp;
	point1[1]=V0[1]+N2[1]*temp;
	point1[2]=V0[2]+N2[2]*temp;
  }
  else if (SIGN01_DIF_SIGN2(dv2,dv0,dv1))
  {
    vSinglePoint=1;    /* V1 is single vertex of the plane of triangle (U0,U1,U2) */
	temp=-(DOT(N2,V1)+d2);
	temp=temp/(N2[0]*N2[0]+N2[1]*N2[1]+N2[2]*N2[2]);
	point1[0]=V1[0]+N2[0]*temp;
	point1[1]=V1[1]+N2[1]*temp;
	point1[2]=V1[2]+N2[2]*temp;
  }
  else if (SIGN01_DIF_SIGN2(dv0,dv1,dv2))
  {
     vSinglePoint=2; /* V2 is single vertex of the plane of triangle (U0,U1,U2) */
	temp=-(DOT(N2,V2)+d2);
	temp=temp/(N2[0]*N2[0]+N2[1]*N2[1]+N2[2]*N2[2]);
	point1[0]=V2[0]+N2[0]*temp;
	point1[1]=V2[1]+N2[1]*temp;
	point1[2]=V2[2]+N2[2]*temp;
  }
  /* replace U0,U1,U2 with UU0,UU1,UU2 */
  if      (SIGN01_DIF_SIGN2(du1,du2,du0))
  {
    uSinglePoint=0;						/* U0 is single vertex of the plane of triangle (V0,V1,V2) */
	temp=-(DOT(N1,U0)+d1);
	temp=temp/(N1[0]*N1[0]+N1[1]*N1[1]+N1[2]*N1[2]);
	point2[0]=U0[0]+N1[0]*temp;
	point2[1]=U0[1]+N1[1]*temp;
	point2[2]=U0[2]+N1[2]*temp;
  }
  else if (SIGN01_DIF_SIGN2(du2,du0,du1))
  {
    uSinglePoint=1;		  /* U1 is single vertex of the plane of triangle (V0,V1,V2) */
	temp=-(DOT(N1,U1)+d1);
	temp=temp/(N1[0]*N1[0]+N1[1]*N1[1]+N1[2]*N1[2]);
	point2[0]=U1[0]+N1[0]*temp;
	point2[1]=U1[1]+N1[1]*temp;
	point2[2]=U1[2]+N1[2]*temp;
  }
  else if (SIGN01_DIF_SIGN2(du0,du1,du2))
  {
    uSinglePoint=2;  /* U2 is single vertex of the plane of triangle (V0,V1,V2) */
	temp=-(DOT(N1,U2)+d1);
	temp=temp/(N1[0]*N1[0]+N1[1]*N1[1]+N1[2]*N1[2]);
	point2[0]=U2[0]+N1[0]*temp;
	point2[1]=U2[1]+N1[1]*temp;
